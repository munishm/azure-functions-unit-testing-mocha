# Testing your javascript code in Azure Functions using Mocha

This article demonstrates how to create automated tests for Azure Functions using Mocha, chai and Sinon.
...
The following example describes how to create a JavaScript Function app in VS Code and run and tests with [Mocha](https://mochajs.org). This procedure uses the [VS Code Functions extension](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azurefunctions) to create Azure Functions.
